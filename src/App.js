            ...
            <div className="landing-hero">
              <div className="landing-hero-inner">
                <div>
                  ...
                  <p>
                    Uganda Civil Aviation Authority's Aeronautical Information
                    Service (AIS) provides the information necessary for the
                    safety, regularity, and efficiency of air navigation in
                    Uganda. AIS products are available in paper, CD, and online
                    formats.
                  </p>
                </div>
              </div>
              ...
              {[
                {
                  ...
                  popular: true,
                  breakdown: [
                    { label: "Online AIP (web-based)", value: "200.6 USD" },
                  ],
                  features: [
